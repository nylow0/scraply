...
<div class="archive" id="workflow-panel-research" role="tabpanel" aria-label="Research" tabindex="0">
  <header>
    <div>
      ...
      <h1>{evidenceBacked ? "The evidence behind the ideas." : discoveryRan ? "The research behind the ideas." : "The problem behind the ideas."}</h1>
      <p class="intro">{evidenceBacked
        ? "This is the persisted discovery output that existed before solution generation began."
        : discoveryRan
          ? "Discovery ran, but these candidates did not pass the evidence requirements. The failures remain visible below and in the research export."

...
<style>
  .research-revisions{max-width:1120px;margin:0 auto;padding:26px var(--page-inline) 32px;color:var(--text)}
  ...
  .pending-note{background:#71cfba12;border:1px solid #71cfba30;color:var(--accent-strong)}
  ...
  .request-kind label.chosen{border-color:#71cfba70;background:#71cfba0e;color:var(--text)}.request-kind input{accent-color:var(--accent)}
  ...
  .field textarea{resize:vertical;line-height:1.5}.field-pair{display:grid;grid-template-columns:1fr 1fr;gap:12px}

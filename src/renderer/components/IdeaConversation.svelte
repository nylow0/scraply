...
<style>
  ...
  .versions button.selected { border-color:#26e6a277;background:#0b1711; }
  ...
  .message.user { margin-left:24px;background:#101c16; }
  ...
  @media(max-width:760px) { .columns { display:block; }.version-panel { border-right:0; }.mobile-tabs { display:grid;grid-template-columns:1fr 1fr;border-bottom:1px solid var(--border); }.mobile-tabs button { min-height:44px;background:#000;border:0;color:var(--muted); }.mobile-tabs button[aria-selected="true"] { color:var(--accent);border-bottom:2px solid var(--accent); }.mobile-hidden { display:none; }.version-panel,.conversation-panel { padding:18px; }.send { margin-left:0; } }
</style>
